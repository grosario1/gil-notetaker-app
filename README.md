...
## Usage
As shown below, the user clicks on the 'Get Started' button which will route the user to the notes page and from there the user can add 'Note Title', add 'Note Text'. After adding Note Text, the user can save the note by clicking on the save icon ![save-icon](https://github.com/grosario1/gil-notetaker-app/assets/26330325/ebc0a4c9-af7f-466b-bb70-0d260631403e) from the top right corner of the page.
